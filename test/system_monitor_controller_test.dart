...
void main() {
  final SystemMonitorControllerPlatform initialPlatform = SystemMonitorControllerPlatform.instance;

  test('$MethodChannelSystemMonitorController is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelSystemMonitorController>());
  });

  test('getPlatformVersion', () async {
    SystemMonitorController systemMonitorControllerPlugin = SystemMonitorController();
    MockSystemMonitorControllerPlatform fakePlatform = MockSystemMonitorControllerPlatform();
